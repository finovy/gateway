...
public class NacosConfigAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean(value = NacosContext.class, search = SearchStrategy.CURRENT)
    ...
    @Bean
    @ConditionalOnMissingBean(value = InitApplicationListener.class, search = SearchStrategy.CURRENT)
