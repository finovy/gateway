...
import tech.finovy.gateway.common.exception.ShouldNeverHappenException;
import tech.finovy.gateway.common.loader.CycleDependencyHandler;
import tech.finovy.gateway.common.loader.ReflectionUtil;
...
public class StringUtils {
    ...
    public static String inputStream2String(InputStream is) {
        ...
        try {
            ...
            return baos.toString(Constant.DEFAULT_CHARSET_NAME);
        } catch (Exception e) {
