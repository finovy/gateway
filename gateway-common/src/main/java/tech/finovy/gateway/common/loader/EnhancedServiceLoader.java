...
import tech.finovy.gateway.common.exception.EnhancedServiceNotFoundException;
import tech.finovy.gateway.common.util.StringUtils;
...
import static tech.finovy.gateway.common.util.CollectionUtils.*;
...
public class EnhancedServiceLoader {
    ...
    public static <S> void unload(Class<S> service, String activateName) {
        ...
        if (isNotEmpty(extensionDefinitions)) {
    ...
    private static class InnerEnhancedServiceLoader<S> {
        ...
        private static <S> InnerEnhancedServiceLoader<S> getServiceLoader(Class<S> type) {
            ...
            return (InnerEnhancedServiceLoader<S>) computeIfAbsent(SERVICE_LOADERS, type,
        ...
        private S getExtensionInstance(ExtensionDefinition<S> definition, ClassLoader loader, Class<?>[] argTypes,
            ...
            if (Scope.SINGLETON.equals(definition.getScope())) {
                Holder<Object> holder = computeIfAbsent(definitionToInstanceMap, definition,
                        key -> new Holder<>());
        ...
        private List<ExtensionDefinition<S>> findAllExtensionDefinition(ClassLoader loader) {
            ...
            try {
                ...
                loadFile(DIRECTORY, loader, extensionDefinitions);
            } catch (IOException e) {
        ...
        private ExtensionDefinition<S> getDefaultExtensionDefinition() {
            ...
            return getLast(currentDefinitions);
        }
